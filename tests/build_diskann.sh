...
INDEX_NAME=SSNPP1M_R${R}_L${L}_B${B}_M${M}_float
...
./tests/build_disk_index  --data_type $DATA_TYPE --dist_fn $DIST_FUN --data_path $DATA_FILE --index_path_prefix $INDEX_PATH -R $R -L $L -B $B -M $M -T $T > ${LOG_PATH}